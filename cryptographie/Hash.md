Les **hashs**, à ne pas confondre avec les [[Encryption_Chiffrement]], sont utilisé pour **stocké des données** dans des bases de données de manière à ce qu'elles ne soit **pas lisible clairement**.
