...
Un reverse shell est ce qui se produit quand une cible éxécute un code qui se connecte à notre machine. L'avantage d'un reverse shell est qu'on contourne les règles des firewalls, cependant le problème  