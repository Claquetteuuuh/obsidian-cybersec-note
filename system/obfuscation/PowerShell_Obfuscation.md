...
Il est facile de replacer $True ou $False par des expressions boolean équivalentes, voici une liste d'expression qui renvoit True, il suffit de rajouter un ! avant le \[bool]
